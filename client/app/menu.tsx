    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }, Platform.OS === 'android' && { paddingTop: 0 }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={{ alignItems: 'center', marginTop: 24, marginBottom: 16 }}>
          <Text style={{ fontSize: 12, color: colors.textSecondary, fontWeight: '600' }}>Zenith Finance v1.1.1</Text>
          <Text style={{ fontSize: 10, color: colors.textSecondary, marginTop: 2 }}>Build 1.1.1-release</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
